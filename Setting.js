...
global.owner = process.env.OWNER_NUMBER  || '918972264107' ;  // ADD YOUR NUMBER WITHOUT +
...
global.mztit = process.env.MZTIT ||"D♥︎❚❚♥︎B",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '21_07_2024_SIGMA_MD_nsVeH6Hi_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'sɪɢᴍᴀ-ᴍᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `BLACK DEVIL 😈`, // ADD YOUR NAME
