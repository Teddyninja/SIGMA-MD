...
global.owner = process.env.OWNER_NUMBER  || '918101558336' ;  // ADD YOUR NUMBER WITHOUT +
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '20_07_2024_SIGMA_MD_8FzDbrcU_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
